...
chcp 65001 >nul
echo ========================================
echo PetitionLetter Setup (Windows)
echo ========================================
echo.
...
if exist "data\Test.zip" (
    ...
    powershell -Command "Expand-Archive -Path 'data\Test.zip' -DestinationPath 'backend\data\projects' -Force"
