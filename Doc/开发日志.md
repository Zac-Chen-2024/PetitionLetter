...
#### 实验 2: Leading Role Agent 法律验证

**状态**: 待执行

**目标**: 使用 §204.5(h)(3)(viii) 验证每个 leading_role snippet

**预期效果**:
- SWF (partner) → 过滤
- KEDGE (invited) → 过滤 (如果还存在)
- Venus/Yiqing/ISHTAR → 保留

**结果**: (执行后填写)

---

#### 实验 3: Evidence Grouping 优化
...
**预期效果**:
- Venus + Ying + Yiqing → 1 个论点
- Leading Role 从 5 个减少到 2-3 个
